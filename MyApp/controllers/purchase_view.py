...
def purchase_commit(request):
    try:
        with transaction.atomic():
            ...
            for i in range(len(request.data["purchase"])):
                purchase.product_id = request.data["purchase"][i]["product_id"]
                purchase.qty = request.data["purchase"][i]["qty"]
                purchase.cost = request.data["purchase"][i]["cost"]
